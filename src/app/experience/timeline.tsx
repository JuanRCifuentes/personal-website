        ...
        <div>
            <menu className='flex gap-5 items-center justify-center mb-8'>
                {listOfButtons.map((kind, idx) => (
                    <li key={idx}>
                        <button 
                            className={`px-4 py-2 border border-transparent rounded-full shadow-md bg-white text-blue-900 hover:border-blue-900 active:bg-blue-900 active:text-white`}
